...
* #smoking-type "Smoking type" "Method of tobacco smoking"
* #smoking-units-of-use "Smoking units used" "Amount of smoking use"
* #smoking-pattern-of-daily-use "Smoking pattern of daily use" "Indicates typical use "
* #smoking-cessation-attempts "Smoking cessation attempts" "Number of times attempting to quit smoking"
* #alcohol-episode-name "Alcohol episode name" "Description of alcohol episode"
* #alcohol-period-of-use "Alcohol episode period of use" "Period of alcohol use"
* #alcohol-pattern-of-use "Pattern of alcohol use" "Pattern of alcohol consumption"
* #alcohol-units-of-use "Alcohol units used" "Alcohol quantity of use"
* #alcohol-free-days "Alcohol free days" "Alcohol free days rate"
* #alcohol-binge-drinking-frequency "Alcohol binge drinking frequency" "How often binge drinking"
* #alcohol-binge-drinking-description "Alcohol binge drinking description" "Description of binge drinking"
* #alcohol-cessation-attempts "Alcohol cessation attempts" "Number of alcohol cessation attempts"
* #substance-name "Subtance name" "Name of illicit substance being used"
* #substance-use-status "Substance use status" "Indication of current use of an illict substance"
* #substance-use-description "Substance use description" "Description of substance use"
* #substance-use-last-quit-date "Substance use last quit date" "Quit date of an illicit substance"
* #food-security-status "Food security status" "Assessed food security state"
